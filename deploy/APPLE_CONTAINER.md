...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/killaragorn/sub2api-pro:latest
...
SUB2API_IMAGE=ghcr.io/killaragorn/sub2api-pro:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
