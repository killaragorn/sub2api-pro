...
const GITHUB_REPO = 'killaragorn/sub2api-pro'
// GHCR image published by the downstream release workflow (tags carry no "v" prefix).
const DOCKER_IMAGE = 'ghcr.io/killaragorn/sub2api-pro'
