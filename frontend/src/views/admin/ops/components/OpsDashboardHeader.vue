...
import { formatMemorySizeMB, opsDisplayedErrorCount } from '../utils/opsFormatters'
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 1;">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              type="button"
              @click="openDetails({ titleKey: 'admin.ops.requestDetails.title' })"
            >
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 2;">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="text-[10px] font-bold text-blue-500 hover:underline"
              type="button"
              @click="openDetails({ titleKey: 'admin.ops.requestDetails.title', kind: 'error' })"
            >
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 4;">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="text-[10px] font-bold text-blue-500 hover:underline"
              type="button"
              @click="openDetails({ titleKey: 'admin.ops.latencyDuration', sort: 'duration_desc' })"
            >
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
        ...
        <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-900" style="order: 5;">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="text-[10px] font-bold text-blue-500 hover:underline"
              type="button"
              @click="openDetails({ titleKey: 'admin.ops.ttftLabel', sort: 'duration_desc' })"
            >
              {{ t('admin.ops.requestDetails.details') }}
            </button>
          </div>
