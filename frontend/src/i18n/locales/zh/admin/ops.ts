export default {
    ops: {
      ...
      errorLog: {
        ...
        slaExcludedBadge: 'SLA 排除',
        businessLimitedBadge: '业务限制',
        account: '账号',
        accountId: '账号 ID',
        status: '状态码',
        message: '响应内容',
      ...
      tooltips: {
        ...
        errorTrend: '错误数按运营口径展示（排除业务限制，保留显式 SLA 排除项）；上游错误率排除 429/529。',
        errorDistribution: '按状态码统计的运营错误分布（排除业务限制，保留显式 SLA 排除项）。',
        ...
        sla: '服务等级协议达成率，排除业务限制（如余额不足、配额超限）和显式 SLA 排除项。',
        errors: '错误数按运营口径展示；错误率按 SLA 口径计算，排除业务限制和显式 SLA 排除项。',
