export default {
    ...
    riskControl: {
      ...
      cyberRequestContent: '触发请求（已脱敏）',
      cyberRequestSaved: '已保存 Cyber 请求快照',
      cyberRequestLoading: '正在读取审计快照…',
      cyberRequestLoadFailed: '读取 Cyber 请求快照失败',
      cyberRequestUnavailable: '该记录没有可用的请求快照，可能是升级前产生的历史记录。',
      cyberRequestProtocol: '协议',
      cyberRequestSize: '已保存 {stored} / 原始 {original} 字节',
      cyberRequestTruncated: '请求快照超过 64 KiB，仅保留了脱敏后的头部和尾部。',
