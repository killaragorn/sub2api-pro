export default {
    accounts: {
      ...
      history: {
        title: '历史额度使用',
        description: '查看账号全部历史额度使用汇总',
        viewAll: '查看全部历史',
        backToAccounts: '返回账号列表',
        accountId: '账号 ID：{id}',
        subtitle: '仅展示汇总数据，不包含逐请求明细',
        byDay: '按天',
        byWeek: '按周',
        timezone: '统计时区：{timezone}',
        totalQuotaUsed: '历史额度使用',
        totalRequests: '历史请求数',
        ...
        requests: '请求数',
        tokens: 'Token',
        loading: '正在加载历史额度使用记录...',
        noData: '该账号暂无历史额度使用记录',
        loadError: '历史额度使用记录加载失败',
        accountLoadError: '账号信息加载失败',
        invalidAccount: '无效的账号 ID',
        retry: '重试'
      },
      stats: {
        totalCost: '30天总费用',
