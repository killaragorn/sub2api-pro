export default {
    ...
    dashboard: {
      ...
      cacheToday: '今日缓存',
      periodUsage: '周期用量',
      periodUsageHint: '按日、周、月连续向前查看，切换后同步筛选下方图表',
      previousDay: '上一天',
      nextDay: '下一天',
      previousWeek: '上周',
      nextWeek: '下周',
    ...
    groups: {
      ...
      modelsList: {
        accessibleTitle: '仅允许访问列表中的模型',
        accessibleHint: '开启后，下方配置列表将原样作为 /v1/models 的展示列表和模型访问白名单；未列出的模型会被拒绝，不再根据账号或模型映射自动计算。',
        title: '自定义 /v1/models 模型列表',
        hint: '选择并调整 /v1/models 的展示顺序；开启访问限制后，此列表同时控制允许调用的模型。',
        loading: '正在加载模型列表...',
        empty: '暂无可展示模型',
