export default {
    accounts: {
      ...
      history: {
        title: 'Historical Quota Usage',
        description: 'View the account\'s complete historical quota usage totals',
        viewAll: 'View Full History',
        backToAccounts: 'Back to Accounts',
        accountId: 'Account ID: {id}',
        subtitle: 'Aggregated totals only; individual request details are not shown',
        byDay: 'Daily',
        byWeek: 'Weekly',
        timezone: 'Reporting timezone: {timezone}',
        totalQuotaUsed: 'Historical Quota Used',
        totalRequests: 'Historical Requests',
        totalTokens: 'Historical Tokens',
        activeDays: 'Days With Usage',
        activeWeeks: 'Weeks With Usage',
        range: '{start} to {end}',
        period: 'Period',
        quotaUsed: 'Quota Used',
        standardCost: 'Standard Cost',
        userCost: 'Downstream User Cost',
        requests: 'Requests',
        tokens: 'Tokens',
        loading: 'Loading historical quota usage...',
        noData: 'No historical quota usage is available for this account',
        loadError: 'Failed to load historical quota usage',
        accountLoadError: 'Failed to load account information',
