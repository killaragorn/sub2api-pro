export default {
  promptAudit: {
    ...
    pool: {
      ...
      groqScopeHint: 'Sends text from system, developer, assistant, and user messages. Tool output, images, and files are not sent to this model.',
