export default {
    ...
    riskControl: {
      ...
      cyberRequestContent: 'Triggering Request (redacted)',
      cyberRequestSaved: 'Cyber request snapshot saved',
      cyberRequestLoading: 'Loading audit snapshot…',
      cyberRequestLoadFailed: 'Failed to load the Cyber request snapshot',
      cyberRequestUnavailable: 'No request snapshot is available. This may be a record created before the audit feature was added.',
      cyberRequestProtocol: 'Protocol',
      cyberRequestSize: '{stored} of {original} bytes stored',
      cyberRequestTruncated: 'The request exceeded 64 KiB; only the redacted beginning and end were retained.',
