export default {
    ...
    riskControl: {
      ...
      detailCopy: 'Copy content',
      detailCopied: 'Content copied',
      ...
      cyberRequestSize: '{stored} of {original} request bytes stored',
      cyberRequestTruncated: 'This historical Cyber request was truncated when it was stored.',
