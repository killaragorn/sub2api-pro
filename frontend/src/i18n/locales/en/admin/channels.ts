export default {
    ...
    riskControl: {
      ...
      cyberRequestContent: 'System Prompt / User Input (redacted)',
      cyberRequestSaved: 'Cyber system/user snapshot saved',
      cyberRequestLoading: 'Loading audit snapshot…',
      cyberRequestLoadFailed: 'Failed to load the Cyber system/user snapshot',
      cyberRequestUnavailable: 'No system/user snapshot is available. This may be a record created before the audit feature was added.',
      cyberRequestProtocol: 'Protocol',
      cyberRequestSize: '{stored} of {original} original request bytes stored',
      cyberRequestTruncated: 'The redacted system/user snapshot exceeded 64 KiB; only its beginning and end were retained.',
      cyberUpstreamEvidence: 'Upstream Cyber Error Evidence',
