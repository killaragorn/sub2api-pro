export default {
    ops: {
      ...
      errorLog: {
        ...
        slaExcludedBadge: 'SLA Excluded',
        businessLimitedBadge: 'Business Limited',
        account: 'Account',
      ...
      tooltips: {
        ...
        errorTrend: 'Operational error counts over time (business limits excluded; explicit SLA exclusions remain visible). Upstream rate excludes 429/529.',
        errorDistribution: 'Operational error distribution by status code (business limits excluded; explicit SLA exclusions remain visible).',
        goroutines:
        ...
        sla: 'Service Level Agreement success rate, excluding business limits (e.g., insufficient balance, quota exceeded) and explicit SLA exclusions.',
        errors: 'Error count uses the operational scope; error rate uses SLA scope and excludes business limits and explicit SLA exclusions.',
