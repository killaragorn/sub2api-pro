export default {
    settings: {
      ...
      openaiPrioritySaturation: {
        title: 'OpenAI priority saturation scheduler',
        description: 'Independent from the experimental weighted scheduler. Accounts are selected deterministically by ascending Priority, then ascending account ID; a new session moves on only after the preceding account’s general capacity is full.',
        enable: 'Enable priority saturation scheduling',
        enableHint: 'Mutually exclusive with the experimental weighted scheduler. Switching requires confirmation and submits both switches in one save.',
        activeHint: 'Active: new sessions use general capacity G; established session_hash and previous_response_id affinity may use full capacity C, including reserve R.',
        orderLabel: 'Account order',
        orderValue: 'Priority ascending, then account ID ascending',
        ...
        affinityValue: 'Prefer the full hard limit C',
        reserveLabel: 'Protected slots',
        reserveValue: 'Configure affinity reserve R per account',
        capacityWarning: 'Accounts with R=0 have no affinity protection. C=0 means unlimited concurrency, so an earlier unlimited account will not naturally spill over due to capacity.',
        manageAccounts: 'Open account management to configure Priority, C, and R',
        switchToPriorityTitle: 'Switch to priority saturation scheduling?',
        switchToPriorityMessage: 'This will disable TopK weighted scheduling and enable priority saturation scheduling. Weight settings remain stored for a later switch back.',
        switchToAdvancedTitle: 'Switch to experimental weighted scheduling?',
        switchToAdvancedMessage: 'This will disable priority saturation scheduling and enable TopK weighted scheduling. Per-account affinity reserve R remains active.',
        switchConfirm: 'Confirm switch',
        mutualExclusionError: 'Priority saturation scheduling and experimental weighted scheduling cannot be enabled at the same time. Disable one before saving.'
      },
